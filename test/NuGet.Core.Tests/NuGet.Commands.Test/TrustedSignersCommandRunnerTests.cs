    ...
    public class TrustedSignersCommandRunnerTests
    {
        ...
        public async Task ExecuteCommandAsync_ListAction_ShowsListOfTrustedSignersAsync()
        {
            ...
            using (var test = Test.Create(TrustedSignersAction.List, trustedSignersProvider.Object))
            {
                ...
                test.Logger.Messages.Should().Contain("Registered trusted signers:");
                test.Logger.Messages.Should().Contain(" 1.   author [author]\r\n      Certificate fingerprint(s):\r\n        [U] SHA256 - abc\r\n");
                test.Logger.Messages.Should().Contain(" 2.   repo [repository]\r\n      Service Index: https://serviceindex.test/v3/index.json\r\n      Certificate fingerprint(s):\r\n        SHA384 - def\r\n");
            }
        }
